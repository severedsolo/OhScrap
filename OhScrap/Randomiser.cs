...
namespace OhScrap
{
    ...
    public class Randomiser : MonoBehaviour
    {
        ...
        {
            for (double d = 0.0001f; d < 1.0; d += 0.0001f)
            {
